...
Think of something like an email client that has a list of all emails on the left, where you can select an email to see the full email body on the right of the screen:
